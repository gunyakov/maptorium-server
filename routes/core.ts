...
//Config
//------------------------------------------------------------------------------
import config, { saveDefConfig, setDefConfig, userConfig} from "../config/index";
...
router.post('/default', async (req, res) => {
    ...
    if(await saveDefConfig()) {
        ...
        res.json({result: "warning", message: "Default config was updated, but some config saving error."});
    }
...
router.post("/mode", async (req, res) => {
    ...
    if(await setDefConfig("mode", mode)) {
        ...
        res.json({result: "warning", message: "Network mode was changed, but some config saving error."});
    }
});
