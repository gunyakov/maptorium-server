export default {
  ...
  INSERT_ROUTE_POINT: `INSERT INTO routeCoords('routeID', 'lat', 'lng', 'date') VALUES(?, ?, ?, ${Math.floor(Date.now() / 1000)})`,

  SELECT_ROUTE_POINTS: "SELECT lat, lng FROM routeCoords WHERE routeID=? ORDER BY date, ID ASC;",
