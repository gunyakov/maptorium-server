module.exports = {
  ...
  INSERT_ROUTE_POINT: `INSERT INTO routeCoords('routeID', 'lat', 'lon', 'date') VALUES(?, ?, ?, ${Math.floor(new Date().getTime() / 1000)})`,

  SELECT_ROUTE_POINTS: "SELECT lat, lon FROM routeCoords WHERE routeID=? ORDER BY ID;",
