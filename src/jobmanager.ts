import { iJobConfig, CachedTilesList, GenJobInfo, JobsList } from "./interface";
...
class JobManager {
  ...
  public async setTileCachedMap(
    mapID: string,
    zoom: number,
    tilesList: CachedTilesList
  ) {
